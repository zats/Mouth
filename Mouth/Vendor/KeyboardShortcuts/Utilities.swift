...
extension String {
	...
	*/
	var localized: String {
		...
		case "keyboard_shortcut_used_by_menu_item":
			return "The keyboard shortcut is already used by the menu item \"%@\"."
		case "keyboard_shortcut_disallowed":
			return "That keyboard shortcut is not allowed."
		case "keyboard_shortcut_used_by_system":
			return "The keyboard shortcut is already used by macOS."
		case "keyboard_shortcuts_can_be_changed":
			return "You can change keyboard shortcuts in System Settings."
		case "ok":
			return "OK"
		case "force_use_shortcut":
			return "Use Anyway"
		case "space_key":
			return "space"
		default:
