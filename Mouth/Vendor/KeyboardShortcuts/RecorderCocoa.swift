...
extension KeyboardShortcuts {
	...
	*/
	public final class RecorderCocoa: NSSearchField, NSSearchFieldDelegate {
		...
		public var onRecorderActiveStatusChange: ((Bool) -> Void)?
		...
		public var recordingPlaceholder: String
		...
		*/
		public required init(
			for name: Name,
			idlePlaceholder: String = "Record Shortcut",
			recordingPlaceholder: String = "Press Shortcut",
			onChange: ((_ shortcut: Shortcut?) -> Void)? = nil,
			onRecorderActiveStatusChange: ((Bool) -> Void)? = nil
		) {
			self.shortcutName = name
			self.idlePlaceholder = idlePlaceholder
			self.recordingPlaceholder = recordingPlaceholder
			self.onChange = onChange
			self.onRecorderActiveStatusChange = onRecorderActiveStatusChange
		...
		private func endRecording() {
			...
			onRecorderActiveStatusChange?(false)
		...
		override public func becomeFirstResponder() -> Bool {
			...
			onRecorderActiveStatusChange?(true)
